...
public @SuppressWarnings("all") class createCustomer_ta0Customer_ta9Customer_Template extends TemplateServlet 
{ 
  ...
  { 
    return "createCustomer_ta0Customer_ta9Customer";
  }

  public String getTemplateClassName()
  { 
    return "createCustomer_ta0Customer_ta9Customer_Template";
  }
  ...
  { 
    return "createCustomer_ta0Customer_ta9(temp : Ref<Customer>)";
  }
  ...
  { 
    ...
    ident += "tcall508";
    ThreadLocalPage.get().enterTemplateContext("tcall508");
    try
    { 
      Object[] args1215 = {"Date of birth: "};
      utils.LocalTemplateArguments args21214 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21214 != null)
      { 
        args1215 = ArrayUtils.addAll(args1215, args21214.extraArgs);
      }
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta8Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).validateInputs("labelcolumnsString", args1215, newenv, attrsmapout, args21214);
    }
    catch(Exception ex)
    { 
  ...
  { 
    ...
    try
    { 
      Object[] args1218 = {"Date of birth: "};
      utils.LocalTemplateArguments args21217 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21217 != null)
      { 
        args1218 = ArrayUtils.addAll(args1218, args21217.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta8Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).render("labelcolumnsString", args1218, newenv, attrsmapout, args21217);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "labelcolumnsString(Date of birth: )");
  ...
  { 
    ...
    try
    { 
      Object[] args1217 = {"Date of birth: "};
      utils.LocalTemplateArguments args21216 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21216 != null)
      { 
        args1217 = ArrayUtils.addAll(args1217, args21216.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta8Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).handleActions("labelcolumnsString", args1217, newenv, attrsmapout, args21216);
  ...
  { 
    putAction("createCustomer_ta0Customer_ta9Customer_save0", new createCustomer_ta0Customer_ta9Customer_save0()
                                                              { 
  ...
  { 
    ...
    try
    { 
      Object[] args1216 = {"Date of birth: "};
      utils.LocalTemplateArguments args21215 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21215 != null)
      { 
        args1216 = ArrayUtils.addAll(args1216, args21215.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta8Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).storeInputs("labelcolumnsString", args1216, newenv, attrsmapout, args21215);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "labelcolumnsString(Date of birth: )");
