...
@SuppressWarnings("all") public class RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta4Customerpc0  implements utils.RefArg
{ 
  public webdsl.generated.domain.Customer arg0;

  public RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta4Customerpc0 () 
  { }

  public RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta4Customerpc0 (Object arg0) 
  { 
  ...
  { 
    arg0.setAddress((String)org.webdsl.tools.Utils.cast(obj, String.class));
    return arg0;
  }

  public Object get()
  { 
    return (String)arg0.getAddress();
  }
  ...
  { 
    return arg0.getId() + "!" + "RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta4Customerpc0";
  }
  ...
  { 
    ...
    arg0.validateAddress_internal_(vem);
  ...
  { 
    return utils.ThreadLocalServlet.get().getReflectionEntityByName("Customer").getPropertyByName("address");
  }
