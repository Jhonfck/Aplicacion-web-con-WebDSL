...
@SuppressWarnings("all") public class EditCustomerPage extends PageServlet 
{ 
  ...
  editCustomer_Template templateservlet = new editCustomer_Template();
  ...
  private webdsl.generated.domain.Customer arg0;
  ...
  { 
    combinedparams.append("{name:\"" + "arg" + "\", value:\"" + org.apache.commons.lang.StringEscapeUtils.escapeJavaScript(arg0.getNaturalId().toString()) + "\"},");
  }
  ...
  { 
    if(arg0_id != null)
    { 
      arg0 = (webdsl.generated.domain.Customer)hibSession.load(webdsl.generated.domain.Customer.class, java.util.UUID.fromString(arg0_id));
    }
  }
