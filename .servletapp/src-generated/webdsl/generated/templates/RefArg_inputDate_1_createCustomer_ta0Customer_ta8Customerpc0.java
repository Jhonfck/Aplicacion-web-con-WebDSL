...
@SuppressWarnings("all") public class RefArg_inputDate_1_createCustomer_ta0Customer_ta8Customerpc0  implements utils.RefArg
{ 
  public webdsl.generated.domain.Customer temp0;

  public RefArg_inputDate_1_createCustomer_ta0Customer_ta8Customerpc0 () 
  { }

  public RefArg_inputDate_1_createCustomer_ta0Customer_ta8Customerpc0 (Object temp0) 
  { 
  ...
  { 
    temp0.setDateOfBirth((java.util.Date)org.webdsl.tools.Utils.cast(obj, java.util.Date.class));
    return temp0;
  }

  public Object get()
  { 
    return (java.util.Date)temp0.getDateOfBirth();
  }
  ...
  { 
    return temp0.getId() + "!" + "RefArg_inputDate_1_createCustomer_ta0Customer_ta8Customerpc0";
  }
  ...
  { 
    ...
    temp0.validateDateOfBirth_internal_(vem);
