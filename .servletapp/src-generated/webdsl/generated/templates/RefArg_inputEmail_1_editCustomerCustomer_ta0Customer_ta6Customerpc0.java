...
@SuppressWarnings("all") public class RefArg_inputEmail_1_editCustomerCustomer_ta0Customer_ta6Customerpc0  implements utils.RefArg
{ 
  public webdsl.generated.domain.Customer arg0;

  public RefArg_inputEmail_1_editCustomerCustomer_ta0Customer_ta6Customerpc0 () 
  { }

  public RefArg_inputEmail_1_editCustomerCustomer_ta0Customer_ta6Customerpc0 (Object arg0) 
  { 
  ...
  { 
    arg0.setEmail((String)org.webdsl.tools.Utils.cast(obj, String.class));
    return arg0;
  }

  public Object get()
  { 
    return (String)arg0.getEmail();
  }
  ...
  { 
    return arg0.getId() + "!" + "RefArg_inputEmail_1_editCustomerCustomer_ta0Customer_ta6Customerpc0";
  }
  ...
  { 
    ...
    arg0.validateEmail_internal_(vem);
  ...
  { 
    return utils.ThreadLocalServlet.get().getReflectionEntityByName("Customer").getPropertyByName("email");
  }
