...
public @SuppressWarnings("all") class editCustomerCustomer_ta0Customer_ta2Customer_Template extends TemplateServlet 
{ 
  ...
  { 
    return "editCustomerCustomer_ta0Customer_ta2Customer";
  }

  public String getTemplateClassName()
  { 
    return "editCustomerCustomer_ta0Customer_ta2Customer_Template";
  }
  ...
  { 
    return "editCustomerCustomer_ta0Customer_ta2(arg : Customer)";
  }
  ...
  { 
    ...
    ident += "tcall476";
    ThreadLocalPage.get().enterTemplateContext("tcall476");
    try
    { 
      Object[] args1131 = {new RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta2Customerpc0(arg0)};
      utils.LocalTemplateArguments args21130 = env.getExtraLocalTemplateArguments("inputString");
      if(args21130 != null)
      { 
        args1131 = ArrayUtils.addAll(args1131, args21130.extraArgs);
      }
      ...
      ((TemplateServlet)templatecalls.get(ident)).validateInputs("inputString", args1131, newenv, attrsmapout, args21130);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "inputString(arg.surname)");
  ...
  { 
    ...
    try
    { 
      Object[] args1134 = {new RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta2Customerpc0(arg0)};
      utils.LocalTemplateArguments args21133 = env.getExtraLocalTemplateArguments("inputString");
      if(args21133 != null)
      { 
        args1134 = ArrayUtils.addAll(args1134, args21133.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("inputString").newInstance());
      ...
      Map<String, String> attrsmapout = new HashMap<String, String>();
      attrsmapout.put("class", "inputsurname");
      ((TemplateServlet)templatecalls.get(ident)).render("inputString", args1134, newenv, attrsmapout, args21133);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "inputString(arg.surname)");
  ...
  { 
    ...
    try
    { 
      Object[] args1133 = {new RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta2Customerpc0(arg0)};
      utils.LocalTemplateArguments args21132 = env.getExtraLocalTemplateArguments("inputString");
      if(args21132 != null)
      { 
        args1133 = ArrayUtils.addAll(args1133, args21132.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("inputString").newInstance());
      ...
      Map<String, String> attrsmapout = new HashMap<String, String>();
      attrsmapout.put("class", "inputsurname");
      ((TemplateServlet)templatecalls.get(ident)).handleActions("inputString", args1133, newenv, attrsmapout, args21132);
  ...
  { 
    putAction("editCustomerCustomer_ta0Customer_ta2Customer_save0", new editCustomerCustomer_ta0Customer_ta2Customer_save0()
                                                                    { 
  ...
  { 
    ...
    try
    { 
      Object[] args1132 = {new RefArg_inputString_1_editCustomerCustomer_ta0Customer_ta2Customerpc0(arg0)};
      utils.LocalTemplateArguments args21131 = env.getExtraLocalTemplateArguments("inputString");
      if(args21131 != null)
      { 
        args1132 = ArrayUtils.addAll(args1132, args21131.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("inputString").newInstance());
      ...
      Map<String, String> attrsmapout = new HashMap<String, String>();
      attrsmapout.put("class", "inputsurname");
      ((TemplateServlet)templatecalls.get(ident)).storeInputs("inputString", args1132, newenv, attrsmapout, args21131);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "inputString(arg.surname)");
