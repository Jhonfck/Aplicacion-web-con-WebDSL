...
public @SuppressWarnings("all") class createCustomer_ta0Customer_ta12Customer_Template extends TemplateServlet 
{ 
  ...
  { 
    return "createCustomer_ta0Customer_ta12Customer";
  }

  public String getTemplateClassName()
  { 
    return "createCustomer_ta0Customer_ta12Customer_Template";
  }
  ...
  { 
    return "createCustomer_ta0Customer_ta12(temp : Ref<Customer>)";
  }
  ...
  { 
    ...
    ident += "tcall505";
    ThreadLocalPage.get().enterTemplateContext("tcall505");
    try
    { 
      Object[] args1207 = {"Bio: "};
      utils.LocalTemplateArguments args21206 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21206 != null)
      { 
        args1207 = ArrayUtils.addAll(args1207, args21206.extraArgs);
      }
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta11Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).validateInputs("labelcolumnsString", args1207, newenv, attrsmapout, args21206);
    }
    catch(Exception ex)
    { 
  ...
  { 
    ...
    { 
      Object[] args1210 = {"Bio: "};
      utils.LocalTemplateArguments args21209 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21209 != null)
      { 
        args1210 = ArrayUtils.addAll(args1210, args21209.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta11Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).render("labelcolumnsString", args1210, newenv, attrsmapout, args21209);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "labelcolumnsString(Bio: )");
  ...
  { 
    ...
    { 
      Object[] args1209 = {"Bio: "};
      utils.LocalTemplateArguments args21208 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21208 != null)
      { 
        args1209 = ArrayUtils.addAll(args1209, args21208.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta11Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).handleActions("labelcolumnsString", args1209, newenv, attrsmapout, args21208);
  ...
  { 
    putAction("createCustomer_ta0Customer_ta12Customer_save0", new createCustomer_ta0Customer_ta12Customer_save0()
                                                               { 
  ...
  { 
    ...
    { 
      Object[] args1208 = {"Bio: "};
      utils.LocalTemplateArguments args21207 = env.getExtraLocalTemplateArguments("labelcolumnsString");
      if(args21207 != null)
      { 
        args1208 = ArrayUtils.addAll(args1208, args21207.extraArgs);
      }
      if(templatecalls.get(ident) == null)
      { 
        templatecalls.put(ident, (TemplateServlet)env.getTemplate("labelcolumnsString").newInstance());
      ...
      newenv.putWithcall("elements#labelcolumnsString", new utils.TemplateCall("createCustomer_ta0Customer_ta11Customer", getElementsContext(), new Object[]{temp0}, attrs));
      Map<String, String> attrsmapout = TemplateCall.EmptyAttrs;
      ((TemplateServlet)templatecalls.get(ident)).storeInputs("labelcolumnsString", args1208, newenv, attrsmapout, args21207);
    }
    catch(Exception ex)
    { 
      System.out.println("Problem occurred in template call: " + "labelcolumnsString(Bio: )");
